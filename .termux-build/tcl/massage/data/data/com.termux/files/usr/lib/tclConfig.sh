...
# installed.
TCL_PREFIX='/data/data/com.termux/files/usr'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data/data/com.termux/files/usr'
...
TCL_EXTRA_CFLAGS=' -fstack-protector-strong -Oz -DBIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD -pipe -I/data/data/com.termux/files/usr/include'
...
TCL_LD_FLAGS='-L/data/data/com.termux/files/usr/lib -Wl,--enable-new-dtags -Wl,--as-needed -Wl,-z,relro,-z,now -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/data/data/com.termux/files/home/.termux-build/tcl/build -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data/data/com.termux/files/usr/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data/data/com.termux/files/usr/include'
...
# compiled.
TCL_SRC_DIR='/data/data/com.termux/files/home/.termux-build/tcl/src'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/data/data/com.termux/files/usr/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/data/data/com.termux/files/home/.termux-build/tcl/build -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/data/data/com.termux/files/home/.termux-build/tcl/build/libtclstub8.6.a'
