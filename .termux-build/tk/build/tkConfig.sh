...
# installed.
TK_PREFIX='/data/data/com.termux/files/usr'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/data/data/com.termux/files/usr'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/data/data/com.termux/files/home/.termux-build/tk/build -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/data/data/com.termux/files/usr/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/data/data/com.termux/files/usr/include'
...
# compiled.
TK_SRC_DIR='/data/data/com.termux/files/home/.termux-build/tk/src'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/data/data/com.termux/files/home/.termux-build/tk/build -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/data/data/com.termux/files/usr/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/data/data/com.termux/files/home/.termux-build/tk/build/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/data/data/com.termux/files/usr/lib/libtkstub8.6.a'
